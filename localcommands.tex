...
\ifdefined\HANDOUT
  ...
  \definecolor{dgrau}{rgb}{0.2,0.2,0.2}
  ...
  \definecolor{orgrA}{RGB}{   204, 206,  80}
  \definecolor{orgrB}{RGB}{   153, 212,  60}
  \definecolor{orgrC}{RGB}{   102, 218,  40}
  \definecolor{orgrD}{RGB}{    51, 224,  20}
...
\else
  ...
  \definecolor{dgrau}{rgb}{0.3,0.3,0.3}
...
\newcommand{\dgrau}[1]{\textcolor{dgrau}{#1}}
...
\renewcommand<>{\tuerkis}[1]{%
  \alt#2{\beameroriginal{\tuerkis}{#1}}{#1}%
}

\renewcommand<>{\grau}[1]{%
  \alt#2{\beameroriginal{\grau}{#1}}{#1}%
}

\renewcommand<>{\dgrau}[1]{%
  \alt#2{\beameroriginal{\dgrau}{#1}}{#1}%
}
...
\forestset{
  ...
  whytetree/.style={for tree={white}, for children={edge=white}},
...
%% SEMANTIK
\newcommand{\den}[1]{\raisebox{-0.05em}{\scalebox{1.2}{\ensuremath{\llbracket}}}#1\raisebox{-0.05em}{\scalebox{1.2}{\ensuremath{\rrbracket}}}}
\newcommand{\dem}[1]{\den{#1}} % legacy
\newcommand{\Dem}[2]{\den{#1}^{#2}}
\newcommand{\DEM}[1]{\den{#1}^{\mathcal{M},g}}
\newcommand{\DEMM}[1]{\den{#1}^{\mathcal{M},w,i,g}}
\newcommand{\DEMI}[1]{\den{#1}_{\not c}^{\mathcal{M},g}}
%\newcommand{\ram}[1]{{\langle{}#1\rangle}}
\newcommand{\Model}{\ensuremath{\mathcal{M}}}
\newcommand{\Valu}{\ensuremath{\mathcal{V}}}
\newcommand{\ram}[1]{{\langle{}#1\rangle}}
...
\newcommand{\mM}[0]{\ensuremath{\mathcal{M}}}
\newcommand{\mMm}[0]{\ensuremath{\mathcal{M}}}
...
\newcommand{\StrSpace}[1]{%
  \StrSubstitute{#1}{+}{ }%
}

\NewDocumentCommand{\letterssub}{m}{%
%  \saveexpandmode\noexpandarg
  \def\tempstring{#1}%
  \xStrSubstitute{\tempstring}{+}{ }[\tempstring]%
  \xStrSubstitute{\tempstring}{-a}{ä}[\tempstring]%
  \xStrSubstitute{\tempstring}{-o}{ö}[\tempstring]%
  \xStrSubstitute{\tempstring}{-u}{ü}[\tempstring]%
  \xStrSubstitute{\tempstring}{-l}{$\lambda$}[\tempstring]%
  \tempstring
%  \restoreexpandmode
}
