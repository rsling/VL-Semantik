...
\title{Semantics{ }\\(7) Intensionality}
\author{Roland Sch\"afer (University of G\"ottingen)}
\date{Summer Term 2005 (June 15)}
...
\begin{itemize}
  ...
  \item<3-> representation of \bl{temporarily ordered world-time coordinates $\ram{w,i}\in{}W\times{}I$}
   \begin{center}
     \includegraphics[scale=0.3]{psoas.jpg}
   \end{center}
\end{itemize}
}
...
\begin{itemize}
  ...
  \medskip
   \begin{center}
     \includegraphics[scale=0.3]{propfunction.jpg}
   \end{center}
\end{itemize}
}
...
\begin{itemize}
  ...
  \medskip
   \begin{center}
     \includegraphics[scale=0.3]{entailment.jpg}
   \end{center}
\end{itemize}
}
...
\begin{itemize}
  ...
  \medskip
   \begin{center}
     \includegraphics[scale=0.3]{equivalence.jpg}
   \end{center}
\end{itemize}
}
...
\begin{itemize}
  ...
  \medskip
   \begin{center}
     \includegraphics[scale=0.3]{contradiction.jpg}
   \end{center}
\end{itemize}
}
...
\begin{itemize}
  ...
  \medskip
   \begin{center}
     \includegraphics[scale=0.3]{not-p.jpg}
   \end{center}
\end{itemize}
}
...
\begin{itemize}
  ...
  \medskip
   \begin{center}
     \includegraphics[scale=0.3]{necessarily-p.jpg}
...
\begin{itemize}
  ...
  \medskip
   \begin{center}
     \includegraphics[scale=0.3]{possibly-p.jpg}
   \end{center}
\end{itemize}
}
...
\begin{itemize}
  ...
  \medskip
   \begin{center}
     \includegraphics[scale=0.3]{wxi-to-u.jpg}
   \end{center}
\end{itemize}
}

\frame{\frametitle{... and pred_ns}
\begin{itemize}
  ...
  \medskip
   \begin{center}
     \includegraphics[scale=0.27]{wxi-to-Puxu.jpg}
   \end{center}
\end{itemize}
}
