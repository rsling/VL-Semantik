...
\begin{frame}
  ...
  \onslide<+->
  \onslide<+->
  \gruen<4->{Wenn} es \blau<5->{r}egnet \gruen<6->{oder} \blau<7->{g}ewittert, \gruen<4->{dann} \orongsch<8->{ist es nicht der Fall, dass} die Sonne \blau<9->{s}cheint \gruen<10->{und} der Wind \orongsch<11->{nicht} \blau<12->{b}läst.
  Die Sonne \blau<14->{s}cheint \gruen<15->{und} der Wind \blau<17->{b}läst \orongsch<16->{nicht}. \textbf{Zeigen Sie: Es regnet oder gewittert.}
  \Halbzeile
  \begin{itemize}[<+->]
