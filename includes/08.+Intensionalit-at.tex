...
\begin{frame}
  ...
  \onslide<+->
  \onslide<+->
  Bedeutung (\alert{Extension}) und Sinn (\alert{Intension})\\
  \onslide<+->
  \Zeile
  \centering 
  \begin{tabular}{lll}
    \toprule
    \textbf{Synt.\ Typ} & \textbf{Bedeutung} & \textbf{Sinn} \\
    \midrule
    NP & Individuum & Individuenkonzept \\
       & \emph{Venus} & \\
    VP & Menge & Eigenschaftskonzept \\
       & \emph{Kolibri} & \\
    S  & \{0,1\} & Gedanke\slash \alert{Proposition} \\
       & \emph{Ich mag Kolibris.} & \\
    \bottomrule
  \end{tabular}
\end{frame}
...
\section{Intensionale Modelltheory}
