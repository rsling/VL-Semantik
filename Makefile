...
handout07: $(OUTDIR)/07.+Getypte+-l-Sprachen+h-oherer+Ordnung$(HANDOUTSUFF)$(PROJECT)$(SUFFSUFF)
...
slides07: $(OUTDIR)/07.+Getypte+-l-Sprachen+h-oherer+Ordnung$(SLIDESUFF)$(PROJECT)$(SUFFSUFF)
