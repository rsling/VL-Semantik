...
handout07: $(OUTDIR)/07.+Getypte+h-oherstufige+-l-Sprachen$(HANDOUTSUFF)$(PROJECT)$(SUFFSUFF)
...
slides07: $(OUTDIR)/07.+Getypte+h-oherstufige+-l-Sprachen$(SLIDESUFF)$(PROJECT)$(SUFFSUFF)
